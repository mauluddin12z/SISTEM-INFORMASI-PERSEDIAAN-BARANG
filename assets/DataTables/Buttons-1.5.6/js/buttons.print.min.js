...
(function(c) {
    ...
    k.ext.buttons.print = {
        ...
        action: function(b, a, d, g) {
			var periode = document.getElementById('periode').innerHTML;
			var periodedt = document.getElementById('periodedt').innerHTML;
			var periodest = document.getElementById('periodest').innerHTML;
            ...
            var k = a.columns(g.exportOptions.columns).flatten().map(function(b) {
                ...
                h = '<table style="font-size: 12px;" class="table table-bordered border-dark mt-3">';
            ...
            f.document.body.innerHTML ='<h1 style="font-size:12px; text-align:center;font-weight:bold; margin-bottom:10px;">'+$('h2').html()+'<br>'+'BARANG MILIK NEGARA<br>FKIP UNIVERSITAS SRIWIJAYA<br>'+'</h1>'+'<p style="font-size:12px; text-align:left; margin-bottom:10px;">'+periode+periodedt+periodest+'</p>'+"<div>" + (d.messageTop || "") + "</div>" + h + "<div>" + (d.messageBottom || "") + "</div>";
